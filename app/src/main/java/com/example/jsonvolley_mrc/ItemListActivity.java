...
import com.example.jsonvolley_mrc.dummy.DummyContent;
...
public class ItemListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(this, DummyContent.DummyItems, mTwoPane));
    }
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(ItemDetailFragment.ARG_ITEM_ID, item.country);
                    ...
                    intent.putExtra(ItemDetailFragment.ARG_ITEM_ID, item.country);
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            try {
                holder.mIdView.setText((CharSequence) mValues.get(position).getJSONArray("country"));
            } catch (JSONException e) {
                e.printStackTrace();
            }
            try {
                holder.mContentView.setText((CharSequence) mValues.get(position).getJSONArray("description"));
            } catch (JSONException e) {
                e.printStackTrace();
            }
